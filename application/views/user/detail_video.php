              ...
              <div class="col-sm-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-lg-8">
                        <small class="badge badge-primary">Post video</small><br>
                         <small class="mt-3"><i class="far fa-calendar-minus"></i> Dipost: <?= $det_video['date'] ?></small>

                        <div class="card-title mt-4">
                          <h2><strong><?= $det_video['judul_post'] ?></strong></h2>
                        </div>
                        <div class="row">
                       ...
                       <div class="card" style="margin-top: 100px; margin-bottom: 40px;">
                        ...
                        <img src="<?= base_url() ?>assets_admin/img/<?= $berita_baru['images'] ?>" class="card-img-top img-fluid" alt="...">
                         ...
                         <h3 class="mt-3"><a href="<?= base_url('news/') ?><?= $berita_baru['kategori_berita'] ?>/<?= $berita_baru['slug'] ?>" class="text-dark"><?= $berita_baru['judul_berita'] ?></a></h3>
                          <small class=""><i class="far fa-calendar-minus"></i> Dipost: <?= $berita_baru['date'] ?></small>
                    ...
                    <div class="card" style="margin-top: 30px; margin-bottom: 40px;">
                        ...
                        <img src="<?= base_url() ?>assets_admin/img/<?= $berita_baru2['images'] ?>" class="card-img-top img-fluid" alt="...">
                         ...
                         <h3 class="mt-3"><a href="<?= base_url('news/') ?><?= $berita_baru2['kategori_berita'] ?>/<?= $berita_baru['slug'] ?>" class="text-dark"><?= $berita_baru2['judul_berita'] ?></a></h3>
                          <small class=""><i class="far fa-calendar-minus"></i> Dipost: <?= $berita_baru['date'] ?></small>
