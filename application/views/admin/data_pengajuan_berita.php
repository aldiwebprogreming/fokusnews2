                ...
                <tr> 
                   ...
                   <td><?= $no++; ?></td>
                    ...
                    <?php if ($data['status'] == 0) { ?>
                      ...
                      <small class="badge badge-warning">Belum disetujui</small>
                      ...
                      <div class="modal fade" id="exampleModal<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <h4>Apakah anda ingin menyetujui berita  ini ?</h4>
                            <form method="post" action="<?= base_url() ?>admin/setujui_berita">
                                
                                <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                <input type="hidden" name="kode_berita" value="<?= $data['kode_berita'] ?>">
                    ...
                    <?php 
                      ...
                      if ($data['status'] == 1) {
                        echo "<small class='badge badge-success'>Disetujui</small>";
                         ...
                         echo "<small class='badge badge-danger'>Belum disetujui</small>";
                      }
                     ?>
                    <hr>
