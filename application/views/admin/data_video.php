          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <!--  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="margin-bottom: 20px;">
                ...
                <a href="<?= base_url() ?>admin/post_video" class="btn btn-primary mb-4"><i class="fas fa-plus"></i> Tambah post video</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr> 
                   ...
                   <td><?= $no++; ?></td>
                    ...
                    <td><?= substr($data['keterangan_post'],0,200)  ?></td>
                    ...
                    <td>
                      ...
                      <a href="<?= base_url() ?>admin/edit_video/<?= $data['kode_post'] ?>" class="btn btn-warning" style="color: white;">Edit</a>
                      ...
                      <div class="modal fade" id="exampleModalhps<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <form method="post" action="<?= base_url() ?>admin/hapus_post_video">
