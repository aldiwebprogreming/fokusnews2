            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 ><strong>Tambah Pedoman Media Sebar</strong></h3>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-8">
                         <form method="POST" action="<?= base_url()  ?>admin/input_pedoman_media">
                            
                          <div class="form-group">
                            <label for="exampleInputPassword1">Isi Pedoman Media</label>
